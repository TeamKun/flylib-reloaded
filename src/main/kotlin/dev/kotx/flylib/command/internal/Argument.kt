...
sealed class Argument<T>(
    ...
    val tabComplete: CompletionAction? = null,
) {
    class Anchor @JvmOverloads constructor(
        name: String,
        tabComplete: CompletionAction? = null,
    ...
    class Angle @JvmOverloads constructor(
        name: String, tabComplete: CompletionAction? = null,
...
fun interface CompletionAction {
    fun SuggestionBuilder.complete()
}